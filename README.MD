...
1.  **Install the component** via the Joomla! Extensions Manager. You can install it from this url: [https://github.com/brettvac/redirectfixer/releases/latest/download/com_redirectfixer.zip](https://github.com/brettvac/redirectfixer/releases/latest/download/com_redirectfixer.zip)
