...
1.  Install the ;atest release via the Joomla! Extensions Manager from this url: [https://github.com/brettvac/redirectfixer/releases/latest/download/com_redirectfixer.zip](https://github.com/brettvac/redirectfixer/releases/latest/download/com_redirectfixer.zip)
...
**A:** No, the component specifically focuses on **internal links** within your Joomla! site's articles that correspond to redirects you've set up *for your own domain*.
